...
export const Hero = () => {
  return <section className="h-[700px] md:h-[800px] flex items-center relative overflow-hidden [mask-image:linear-gradient(to_bottom,transparent,black_10%,black_90%,transparent)] "
    style={{
    ...
    <div className="absolute h-[380px] w-[380px] md:h-[580px] md:w-[580px] rounded-full border-white/20 border top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
    ...
    <div className="absolute h-[450px] w-[450px] md:h-[650px] md:w-[650px] rounded-full border border-white/20 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 border-dashed"></div>
    <div className="absolute h-[544px] w-[544px] md:h-[900px] md:w-[900px] rounded-full border border-white/20 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
      <div className="absolute h-3 w-3 left-0 bg-white/20 rounded-full top-1/2 -translate-x-1/2 -translate-y-1/2"></div>
